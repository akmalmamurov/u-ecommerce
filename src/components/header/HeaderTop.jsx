            ...
            <Box display="flex" alignItems={"center"} gap="24px">
              <Box display={"flex"} alignItems={"center"} gap={"2px"}>
                ...
                <Box className="header-top_left" gap={"2px"}>
                  <Text fontSize={"14px"}>Город:</Text>
                  <Text fontSize={"14px"} cursor={"pointer"}>
                    Ташкент
                  </Text>
                </Box>
              </Box>
              <Text fontSize={"14px"}>Пунтк выдачи</Text>
            </Box>

            <Box display={{ base: "none", md: "block" }}>
              <Text fontSize={"14px"} color={" #8B8E99"}>
                Доставим ваш товар бесплатно - всего за 1 день
              </Text>
            </Box>
            <Box display={"flex"} alignItems={"center"} gap={"16px"} fontSize={"14px"}>
              <Link cursor={"pointer"}>Вопрос-ответ</Link>
              <Link cursor={"pointer"}>Мои заказы</Link>
            </Box>
          </Box>
        </Container>
      </Box>
